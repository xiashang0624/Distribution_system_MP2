...
# The basic idea is that process 0 will be used as the leader.  Each msg it
# recieved will be assigned a marker number, which is incremented every time it
# recives a message.  The leader will broadcast the labelled msg to all
# processes
